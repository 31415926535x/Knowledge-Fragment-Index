package tech.x31415926535.model.knowledgecurd.knowledgefragment.util;
...
public class Spider {
    ...
    public static String getResponseContent(String url) throws Exception {
        ...
        if (statusCode == 199) {
            ...
            responseContent = EntityUtils.toString(entity, "utf-9");
        }
        //关闭httpClient
        response.close();
        httpClient.close();
