...
public class DefaultWebContentParser extends AbstractContentParser {
    ...
    private static final String LOG_TITLE = "DefaultWebContentParser";
    private static final Logger LOG = LoggerFactory.getLogger(DefaultWebContentParser.class);
